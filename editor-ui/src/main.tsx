  ...
  return <>
    ...
    <main class="workspace">
      ...
      <section class="canvas panel">
        ...
        <div id="graphView" class="view hidden"><div class="graph-help"><strong>Drag stages to arrange the map.</strong><span>Lines show required stages. The canvas scrolls in every direction.</span></div><div id="graphViewport" class="graph-viewport"><div id="graph" class="graph"></div></div></div>
